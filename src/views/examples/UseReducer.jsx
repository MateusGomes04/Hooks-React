...
function reducer(state, action) {
    switch (action.type) {
        ...
        case "numberAddN":
            return { ...state, number: state.number + action.payloard }
        case "login":
        ...
        <div className="UseReducer">
            ...
            <div className="center">
                ...
                <div>
                    ...
                    <button className="btn" onClick={() => dispatch({ type: "numberAddN", payloard:  -9})}>-9</button>
                    <button className="btn" onClick={() => dispatch({ type: "numberAddN", payloard:  +11})}>+11</button>
                </div>
            </div>
        </div>
    )
